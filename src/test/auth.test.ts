...
import { GoogleSpreadsheet, GoogleSpreadsheetWorksheet, GoogleSpreadsheetCell } from '../index';

import { DOC_IDS, testServiceAccountAuth } from './docs-and-auth';
import apiKey from './api-key';
import { GoogleSpreadsheetAuth } from '../lib/GoogleSpreadsheet';

function checkDocAccess(
  docType: keyof typeof DOC_IDS,
  auth: GoogleSpreadsheetAuth,
  spec: { 
    canRead?: boolean,
    canWrite?: boolean,
    readError?: string,
