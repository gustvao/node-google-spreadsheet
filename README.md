# google-spreadsheet
> The most popular [Google Sheets API](https://developers.google.com/sheets/api/reference/rest) wrapper for javascript (and typescript)
...
- managing docs - create new doc, delete doc, set sharing/permissions
...
> 🌈 **Installation** - `npm i google-spreadsheet --save` or `yarn add google-spreadsheet` or `pnpm add google-spreadsheet`
...
const doc = new GoogleSpreadsheet('<the sheet ID from the url>', new JWT({
